<template>
  <div class="h-screen overflow-hidden">
    <pokemon-navbar v-model="filterText" />
...
const pokemonStore = reactive({
  ...
  filteredPokemon: computed((): Pokemon[] => pokemonStore.allPokemon.filter((pokemon: Pokemon)=> pokemon.pokemon_species.name.includes(filterText.value.toLowerCase())))
});
